...
# Falls der Parameter (sticky=tk.W, Richtungen NWSE) gesetzt ist wird das Objekt nicht zentriert
...
buttons_frame = ttk.LabelFrame(win, text=' Labels in a Frame ', sticky='WE')
buttons_frame.grid(column=0, row=7) #oder (column=1,padx=20, pady=40 für Mitte)
